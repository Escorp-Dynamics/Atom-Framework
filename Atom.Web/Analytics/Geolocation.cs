...
public class Geolocation : Reactively, IParsable<Geolocation?>, IEquatable<Geolocation>, ISerializable
{
    ...
    {
        return default; // TODO: Доработать.
    }
    ...
    public static bool TryParse([NotNullWhen(true)] string? s, IFormatProvider? provider, [MaybeNullWhen(false)] out Geolocation? result)
    {
        throw new NotImplementedException();
    }
