...
public partial class Log : ILog
{
    ...
    /// <returns></returns>
    protected virtual ValueTask OnWriting(LogEventArgs e) => Writing?.Invoke(this, e) ?? ValueTask.CompletedTask;
    ...
    /// <inheritdoc/>
    public virtual async ValueTask WriteAsync<T>([NotNull] ILogInfo<T> info, LogMode mode, CancellationToken cancellationToken)
    {
    ...
    /// <inheritdoc/>
    public virtual ValueTask WriteLineAsync<T>([NotNull] ILogInfo<T> info, LogMode mode, CancellationToken cancellationToken)
    {
