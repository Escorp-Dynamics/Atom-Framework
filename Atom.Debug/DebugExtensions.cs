...
public static class DebugExtensions
{
    ...
    public static string AsString(this ConsoleColor color, bool isBackground) => Console.IsOutputRedirected ? string.Empty : isBackground
        ? color switch
        {
    ...
    public static string AsString(this ConsoleStyle style, bool isEnding) => Console.IsOutputRedirected ? string.Empty : isEnding
        ? style switch
        {
