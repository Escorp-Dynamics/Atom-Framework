...
public class StatusCommandResultTests
{
    ...
    public void TestCanDeserialize()
    {
        string json = """
                      ...
                      """;
        StatusCommandResult? result = JsonSerializer.Deserialize<StatusCommandResult>(json, JsonContext.Default.StatusCommandResult);
    ...
    public void TestDeserializingWithMissingReadyThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<StatusCommandResult>(json, JsonContext.Default.StatusCommandResult), Throws.InstanceOf<JsonException>());
    }
