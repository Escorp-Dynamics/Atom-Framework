...
public class NewCommandResultTests
{
    ...
    public void TestCanDeserialize()
    {
        string json = """
                      ...
                      """;
        NewCommandResult? result = JsonSerializer.Deserialize<NewCommandResult>(json, JsonContext.Default.NewCommandResult);
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(result.Capabilities.IsAcceptInsecureCertificates, Is.EqualTo(true));
            ...
            Assert.That(result.Capabilities.IsSetWindowRect, Is.EqualTo(true));
    ...
    public void TestDeserializingWithMissingSessionIdThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<NewCommandResult>(json, JsonContext.Default.NewCommandResult), Throws.InstanceOf<JsonException>());
    }
