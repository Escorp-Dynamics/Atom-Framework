...
public class UnsubscribeCommandParametersTests
{
   [Test]
    ...
    public void TestCanSerializeByAttributesParameters()
    {
        ...
        string json = JsonSerializer.Serialize(properties, JsonContext.Default.UnsubscribeByAttributesCommandParameters);
    ...
    public void TestCanSerializeByIdsParameters()
    {
        ...
        string json = JsonSerializer.Serialize(properties, JsonContext.Default.UnsubscribeByIdsCommandParameters);
        JObject serialized = JObject.Parse(json);
        Assert.That(serialized, Has.Count.EqualTo(1));
        Assert.Multiple(() =>
        {
