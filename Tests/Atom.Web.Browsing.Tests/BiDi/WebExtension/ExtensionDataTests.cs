...
public class ExtensionDataTests
{
    ...
    public void TestCanSerializeExtensionPathExtensionData()
    {
        ...
        string json = JsonSerializer.Serialize(value, JsonContext.Default.ExtensionPath);
    ...
    public void TestCanSerializeExtensionArchivePathExtensionData()
    {
        ...
        string json = JsonSerializer.Serialize(value, JsonContext.Default.ExtensionArchivePath);
        JObject parsed = JObject.Parse(json);
        Assert.Multiple(() =>
        {
            Assert.That(parsed, Has.Count.EqualTo(2));
    ...
    public void TestCanSerializeExtensionBase64EncodedExtensionData()
    {
        ...
        string json = JsonSerializer.Serialize(value, JsonContext.Default.ExtensionBase64Encoded);
        JObject parsed = JObject.Parse(json);
        Assert.Multiple(() =>
        {
            Assert.That(parsed, Has.Count.EqualTo(2));
