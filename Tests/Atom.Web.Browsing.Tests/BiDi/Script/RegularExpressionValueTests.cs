...
public class RegularExpressionValueTests
{
    ...
    public void TestCanDeserialize()
    {
        string json = """
                      ...
                      """;
        RegularExpressionValue? regexProperties = JsonSerializer.Deserialize<RegularExpressionValue>(json, JsonContext.Default.RegularExpressionValue);
    ...
    {
        string json = "{}";
        Assert.That(() => JsonSerializer.Deserialize<RegularExpressionValue>(json, JsonContext.Default.RegularExpressionValue), Throws.InstanceOf<JsonException>());
    }
    ...
    public void TestEquality()
    {
        ...
        string json = """
                      ...
                      """;
        RegularExpressionValue? actualRegexValue = JsonSerializer.Deserialize<RegularExpressionValue>(json, JsonContext.Default.RegularExpressionValue);
