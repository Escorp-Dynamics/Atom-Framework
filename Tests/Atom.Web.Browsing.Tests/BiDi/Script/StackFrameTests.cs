...
public class StackFrameTests
{
    ...
    public void TestCanDeserialize()
    {
        string json = """
                      ...
                      """;
        StackFrame? stackFrame = JsonSerializer.Deserialize<StackFrame>(json, JsonContext.Default.StackFrame);
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(stackFrame.Url.OriginalString, Is.EqualTo("http://some.url/file.js"));
        });
    }
    ...
    public void TestDeserializeWithMissingFunctionNameThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<StackFrame>(json, JsonContext.Default.StackFrame), Throws.InstanceOf<JsonException>());
    }
