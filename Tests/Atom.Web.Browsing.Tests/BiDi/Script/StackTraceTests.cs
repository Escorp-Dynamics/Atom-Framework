...
public class StackTraceTests
{
    ...
    public void TestCanDeserialize()
    {
        string json = """
                      ...
                      """;
        StackTrace? stacktrace = JsonSerializer.Deserialize<StackTrace>(json, JsonContext.Default.StackTrace);
    ...
    {
        string json = "{}";
        Assert.That(() => JsonSerializer.Deserialize<StackTrace>(json, JsonContext.Default.StackTrace), Throws.InstanceOf<JsonException>());
    }
