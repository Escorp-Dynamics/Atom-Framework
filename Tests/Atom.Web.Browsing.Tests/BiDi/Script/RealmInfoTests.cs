...
public class RealmInfoTests
{
    ...
    public void TestCanDeserializeWorkerRealmInfo()
    {
        string json = """
                      ...
                      """;
        RealmInfo? info = JsonSerializer.Deserialize<RealmInfo>(json, JsonContext.Default.RealmInfo);
    ...
    public void TestDeserializingRealmInfoWithMissingRealmThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<RealmInfo>(json, JsonContext.Default.RealmInfo), Throws.InstanceOf<JsonException>().With.Message.Contains("Свойство 'realm' в RealmInfo обязательно"));
    }
    ...
    public void TestDeserializingRealmInfoWithInvalidRealmTypeThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<RealmInfo>(json, JsonContext.Default.RealmInfo), Throws.InstanceOf<JsonException>().With.Message.Contains("Свойство 'realm' в RealmInfo должно быть строкой"));
    }
    ...
    public void TestDeserializingRealmInfoWithMissingOriginThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<RealmInfo>(json, JsonContext.Default.RealmInfo), Throws.InstanceOf<JsonException>().With.Message.Contains("Свойство 'origin' в RealmInfo обязательно"));
    }
    ...
    public void TestDeserializingRealmInfoWithInvalidOriginTypeThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<RealmInfo>(json, JsonContext.Default.RealmInfo), Throws.InstanceOf<JsonException>().With.Message.Contains("Свойство 'origin' в RealmInfo должно быть строкой"));
    }
    ...
    public void TestDeserializingRealmInfoWithMissingTypeThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<RealmInfo>(json, JsonContext.Default.RealmInfo), Throws.InstanceOf<JsonException>().With.Message.Contains("Свойство 'type' в RealmInfo обязательно"));
    }
    ...
    public void TestDeserializingRealmInfoWithInvalidTypeThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<RealmInfo>(json, JsonContext.Default.RealmInfo), Throws.InstanceOf<BiDiException>().With.Message.Contains("недопустимо для типа перечисления"));
    }
    ...
    public void TestDeserializingRealmInfoWithNonStringTypeThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<RealmInfo>(json, JsonContext.Default.RealmInfo), Throws.InstanceOf<JsonException>());
    }
    ...
    public void TestDeserializingWindowRealmInfoWithMissingContextThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<RealmInfo>(json, JsonContext.Default.RealmInfo), Throws.InstanceOf<JsonException>().With.Message.Contains("Свойство 'context' в WindowRealmInfo обязательно"));
    }
    ...
    public void TestDeserializingWindowRealmInfoWithInvalidContextTypeThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<RealmInfo>(json, JsonContext.Default.RealmInfo), Throws.InstanceOf<JsonException>().With.Message.Contains("Свойство 'context' в WindowRealmInfo должно быть строкой"));
    }
    ...
    public void TestDeserializingWindowRealmInfoWithInvalidSandboxTypeThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<RealmInfo>(json, JsonContext.Default.RealmInfo), Throws.InstanceOf<JsonException>().With.Message.Contains("Свойство 'sandbox' в WindowRealmInfo должно быть строкой"));
    }
    ...
    public void TestDeserializingDedicatedWorkerRealmInfoWithMissingOwnersThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<RealmInfo>(json, JsonContext.Default.RealmInfo), Throws.InstanceOf<JsonException>().With.Message.Contains("Свойство 'owners' в DedicatedWorkerRealmInfo обязательно"));
    }
    ...
    public void TestDeserializingDedicatedWorkerRealmInfoWithInvalidOwnersTypeThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<RealmInfo>(json, JsonContext.Default.RealmInfo), Throws.InstanceOf<JsonException>().With.Message.Contains("Свойство 'owners' в DedicatedWorkerRealmInfo должно быть массивом"));
    }
    ...
    public void TestDeserializingDedicatedWorkerRealmInfoWithInvalidOwnersEntryTypeThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<RealmInfo>(json, JsonContext.Default.RealmInfo), Throws.InstanceOf<JsonException>().With.Message.Contains("Все элементы массива 'owners' в DedicatedWorkerRealmInfo должны быть строками"));
    }
    ...
    public void TestDeserializingDedicatedWorkerRealmInfoWithInvalidOwnersEntryValueThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<RealmInfo>(json, JsonContext.Default.RealmInfo), Throws.InstanceOf<JsonException>().With.Message.Contains("Все элементы массива 'owners' в DedicatedWorkerRealmInfo должны быть непустыми строками"));
    }
    ...
    public void TestCannotCastToImproperSubclassTypeOfRealmInfo()
    {
        ...
        Assert.That(info, Is.Not.Null);
        Assert.That(info, Is.InstanceOf<ServiceWorkerRealmInfo>());
        Assert.That(() => info!.As<SharedWorkerRealmInfo>(), Throws.InstanceOf<BiDiException>().With.Message.Contains("cannot be cast"));
    }
    ...
    public void TestCannotSerialize()
    {
        ...
        string json = """
                      ...
                      """;
        RealmInfo? info = JsonSerializer.Deserialize<RealmInfo>(json, JsonContext.Default.RealmInfo);
        Assert.That(() => JsonSerializer.Serialize(info), Throws.InstanceOf<InvalidOperationException>());
    }
}
