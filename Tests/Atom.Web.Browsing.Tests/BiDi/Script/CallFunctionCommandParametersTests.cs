...
public class CallFunctionCommandParametersTests
{
   [Test]
    ...
    {
        CallFunctionCommandParameters properties = new("myFunction", new RealmTarget("myRealm"), true);
        string json = JsonSerializer.Serialize(properties, JsonContext.Default.CallFunctionCommandParameters);
    ...
    {
        CallFunctionCommandParameters properties = new("myFunction", new RealmTarget("myRealm"), true);
        properties.Arguments = [LocalValue.String("myArgument")];
        ...
        properties.IsUserActivation = true;
        string json = JsonSerializer.Serialize(properties, JsonContext.Default.CallFunctionCommandParameters);
        JObject serialized = JObject.Parse(json);
