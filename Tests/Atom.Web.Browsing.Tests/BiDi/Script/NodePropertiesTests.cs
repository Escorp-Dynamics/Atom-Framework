...
public class NodePropertiesTests
{
    ...
    public void TestCanDeserialize()
    {
        string json = """
                      ...
                      """;
        NodeProperties? nodeProperties = JsonSerializer.Deserialize<NodeProperties>(json, JsonContext.Default.NodeProperties);
    ...
    public void TestDeserializeWithMissingNodeTypeThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<NodeProperties>(json, JsonContext.Default.NodeProperties), Throws.InstanceOf<JsonException>());
    }
    ...
    public void TestCanDeserializeWithOptionalNamespaceUri()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(nodeProperties.NodeValue, Is.Null);
            Assert.That(nodeProperties.LocalName, Is.Null);
            Assert.That(nodeProperties.NamespaceUri?.OriginalString, Is.EqualTo("myNamespace"));
            Assert.That(nodeProperties.Attributes, Is.Null);
            Assert.That(nodeProperties.Children, Is.Null);
            Assert.That(nodeProperties.ShadowRoot, Is.Null);
            Assert.That(nodeProperties.Mode, Is.Null);
    ...
    public void TestDeserializeWithInvalidModeValueTypeThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<NodeProperties>(json, JsonContext.Default.NodeProperties), Throws.InstanceOf<BiDiException>());
    }
