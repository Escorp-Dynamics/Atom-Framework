...
public class NavigationEventArgsTests
{
    ...
    public void TestCanDeserialize()
    {
        ...
        string json = $$"""
                      ...
                      """;
        NavigationEventArgs? eventArgs = JsonSerializer.Deserialize(json, JsonContext.Default.NavigationEventArgs);
    ...
    public void TestDeserializeWithMissingContextValueThrows()
    {
        ...
        string json = $$"""
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize(json, JsonContext.Default.NavigationEventArgs), Throws.InstanceOf<JsonException>());
    }
