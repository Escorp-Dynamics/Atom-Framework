...
public class NavigateCommandParametersTests
{
    ...
    {
        NavigateCommandParameters properties = new("myContextId", new Uri("http://example.com"));
    ...
    {
        NavigateCommandParameters properties = new("myContextId", new Uri("http://example.com"));
        string json = JsonSerializer.Serialize(properties, JsonContext.Default.NavigateCommandParameters);
