...
public class HistoryUpdatedEventArgsTests
{
    ...
    public void TestCanDeserialize()
    {
        string json = """
                      ...
                      """;
        HistoryUpdatedEventArgs? eventArgs = JsonSerializer.Deserialize(json, JsonContext.Default.HistoryUpdatedEventArgs);
        Assert.That(eventArgs, Is.Not.Null);
        Assert.Multiple(() =>
        {
            Assert.That(eventArgs!.BrowsingContextId, Is.EqualTo("myContextId"));
            Assert.That(eventArgs!.Url, Is.EqualTo(new Uri("http://example.com")));
        });
    }
    ...
    public void TestDeserializeWithMissingContextValueThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize(json, JsonContext.Default.HistoryUpdatedEventArgs), Throws.InstanceOf<JsonException>());
    }
