...
public class UserPromptClosedEventArgsTests
{
    ...
    public void TestCanDeserializeWithAcceptedTrue()
    {
        string json = """
                      ...
                      """;
        UserPromptClosedEventArgs? eventArgs = JsonSerializer.Deserialize(json, JsonContext.Default.UserPromptClosedEventArgs);
    ...
    public void TestDeserializeWithMissingContextValueThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize(json, JsonContext.Default.UserPromptClosedEventArgs), Throws.InstanceOf<JsonException>());
    }
