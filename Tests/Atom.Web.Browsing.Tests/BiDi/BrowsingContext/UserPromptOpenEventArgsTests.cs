...
public class UserPromptOpenedEventArgsTests
{
    ...
    public void TestCanDeserializeWithTypeAlert()
    {
        string json = """
                      ...
                      """;
        UserPromptOpenedEventArgs? eventArgs = JsonSerializer.Deserialize(json, JsonContext.Default.UserPromptOpenedEventArgs);
    ...
    public void TestDeserializeWithMissingContextValueThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize(json, JsonContext.Default.UserPromptOpenedEventArgs), Throws.InstanceOf<JsonException>());
    }
    ...
    public void TestDeserializeWithInvalidTypeValueThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize(json, JsonContext.Default.UserPromptOpenedEventArgs), Throws.InstanceOf<BiDiException>());
    }
