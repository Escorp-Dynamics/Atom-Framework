...
public class LocateNodesCommandParametersTests
{
    ...
    {
        LocateNodesCommandParameters properties = new("myContextId", new CssLocator(".selector"));
        string json = JsonSerializer.Serialize(properties, JsonContext.Default.LocateNodesCommandParameters);
    ...
    public void TestCanSerializeWithContextNode()
    {
        ...
        RemoteValue nodeValue = JsonSerializer.Deserialize(nodeJson, JsonContext.Default.RemoteValue)!;
        LocateNodesCommandParameters properties = new("myContextId", new CssLocator(".selector"));
        properties.ContextNodes = [nodeValue.ToSharedReference()];
