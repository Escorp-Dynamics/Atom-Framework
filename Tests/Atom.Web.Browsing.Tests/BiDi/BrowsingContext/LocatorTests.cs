...
public class LocatorTests
{
    ...
    public void TestCanSerializeUsingBaseType()
    {
        ...
        Assert.That(JsonSerializer.Serialize(locator, JsonContext.Default.CssLocator), Is.Not.Empty);
        locator = new XPathLocator("//locator");
        Assert.That(JsonSerializer.Serialize(locator, JsonContext.Default.XPathLocator), Is.Not.Empty);
        locator = new InnerTextLocator("locator text");
        Assert.That(JsonSerializer.Serialize(locator, JsonContext.Default.InnerTextLocator), Is.Not.Empty);
        locator = new AccessibilityLocator();
        Assert.That(JsonSerializer.Serialize(locator, JsonContext.Default.AccessibilityLocator), Is.Not.Empty);
        locator = new ContextLocator("myContext");
        Assert.That(JsonSerializer.Serialize(locator, JsonContext.Default.ContextLocator), Is.Not.Empty);
    }
    ...
    public void TestCanSerializeCssLocator()
    {
        ...
        string json = JsonSerializer.Serialize(value, JsonContext.Default.CssLocator);
    ...
    public void TestCanSerializeXPathLocator()
    {
        ...
        string json = JsonSerializer.Serialize(value, JsonContext.Default.XPathLocator);
        JObject parsed = JObject.Parse(json);
        Assert.Multiple(() =>
        {
            Assert.That(parsed, Has.Count.EqualTo(2));
    ...
    public void TestCanSerializeInnerTextLocator()
    {
        ...
        string json = JsonSerializer.Serialize(value, JsonContext.Default.InnerTextLocator);
        JObject parsed = JObject.Parse(json);
        Assert.Multiple(() =>
        {
            Assert.That(parsed, Has.Count.EqualTo(2));
    ...
    public void TestCanSerializeAccessibilityLocator()
    {
        ...
        string json = JsonSerializer.Serialize(value, JsonContext.Default.AccessibilityLocator);
        JObject parsed = JObject.Parse(json);
        Assert.Multiple(() =>
        {
            Assert.That(parsed, Has.Count.EqualTo(2));
    ...
    public void TestCanSerializeContextLocator()
    {
        ...
        string json = JsonSerializer.Serialize(value, JsonContext.Default.ContextLocator);
        JObject parsed = JObject.Parse(json);
        Assert.Multiple(() =>
        {
            Assert.That(parsed, Has.Count.EqualTo(2));
