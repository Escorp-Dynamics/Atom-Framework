...
public class PrintCommandParametersTests
{
    ...
    {
        PrintCommandParameters properties = new("myContextId");
        string json = JsonSerializer.Serialize(properties, JsonContext.Default.PrintCommandParameters);
    ...
    public void TestSettingMarginsToInvalidValuesThrows()
    {
        ...
        Assert.Multiple(() =>
        {
            Assert.That(() => properties.Top = -1, Throws.InstanceOf<ArgumentOutOfRangeException>().With.Message.Contains("Значение должно быть больше или равно нулю"));
            Assert.That(() => properties.Bottom = -1, Throws.InstanceOf<ArgumentOutOfRangeException>().With.Message.Contains("Значение должно быть больше или равно нулю"));
            Assert.That(() => properties.Left = -1, Throws.InstanceOf<ArgumentOutOfRangeException>().With.Message.Contains("Значение должно быть больше или равно нулю"));
            Assert.That(() => properties.Right = -1, Throws.InstanceOf<ArgumentOutOfRangeException>().With.Message.Contains("Значение должно быть больше или равно нулю"));
        });
    }
    ...
    public void TestSettingPageSizeToInvalidValuesThrows()
    {
        ...
        Assert.Multiple(() =>
        {
            Assert.That(() => properties.Width = -1, Throws.InstanceOf<ArgumentOutOfRangeException>().With.Message.Contains("Значение должно быть больше или равно нулю"));
            Assert.That(() => properties.Height = -1, Throws.InstanceOf<ArgumentOutOfRangeException>().With.Message.Contains("Значение должно быть больше или равно нулю"));
        });
    }
    ...
    public void TestSettingScaleToInvalidValueThrows()
    {
        ...
        Assert.Multiple(() =>
        {
            Assert.That(() => properties.Scale = -1, Throws.InstanceOf<ArgumentOutOfRangeException>().With.Message.Contains("Значение должно быть в диапазоне от 0.1 до 2.0"));
            Assert.That(() => properties.Scale = 0.01, Throws.InstanceOf<ArgumentOutOfRangeException>().With.Message.Contains("Значение должно быть в диапазоне от 0.1 до 2.0"));
            Assert.That(() => properties.Scale = 2.01, Throws.InstanceOf<ArgumentOutOfRangeException>().With.Message.Contains("Значение должно быть в диапазоне от 0.1 до 2.0"));
            Assert.That(() => properties.Scale = 0, Throws.InstanceOf<ArgumentOutOfRangeException>().With.Message.Contains("Значение должно быть в диапазоне от 0.1 до 2.0"));
        });
    }
    ...
    public void TestSerializeParametersWithInvalidPageRangesThrows()
    {
        ...
        Assert.That(() => JsonSerializer.Serialize(properties, JsonContext.Default.PrintCommandParameters), Throws.InstanceOf<BiDiException>().With.Message.Contains("Диапазон страниц должен быть строкой или целым числом"));
    }
}
