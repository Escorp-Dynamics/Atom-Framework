...
public class MessageTests
{
    ...
    public void TestCanDeserializeCommandResponseMessage()
    {
        string json = """
                      ...
                      """;
        CommandResponseMessage<TestCommandResult>? result = JsonSerializer.Deserialize(json, JsonTestContext.Default.CommandResponseMessageTestCommandResult);
        Assert.Multiple(() =>
        {
    ...
    public void TestCanDeserializeEventMessage()
    {
        string json = """
                      ...
                      """;
        EventMessage<TestEventArgs>? result = JsonSerializer.Deserialize(json, JsonTestContext.Default.EventMessageTestEventArgs);
        Assert.Multiple(() =>
        {
    ...
    public void TestCanDeserializeCommandErrorMessage()
    {
        string json = """
                      ...
                      """;
        ErrorResponseMessage? result = JsonSerializer.Deserialize(json, JsonContext.Default.ErrorResponseMessage);
        Assert.Multiple(() =>
        {
