...
public class TransportTests
{
    ...
    public async Task TestTransportCanSendCommand()
    {
        ...
        _ = await transport.SendCommandAsync(command, JsonTestContext.Default.TestCommandParameters, JsonTestContext.Default.CommandResponseMessageTestCommandResult);
    ...
    {
        var commandName = "module.command";
        var connection = new TestConnection();
        var transport = new Transport(connection);

        await transport.ConnectAsync(new Uri("ws://localhost/"));

        var commandParameters = new TestCommandParameters(commandName);
        var command = await transport.SendCommandAsync(commandParameters, JsonTestContext.Default.TestCommandParameters, JsonTestContext.Default.CommandResponseMessageTestCommandResult);
    ...
    public async Task TestTransportCanGetResponseWithAdditionalData()
    {
        ...
        Command command = await transport.SendCommandAsync(commandParameters, JsonTestContext.Default.TestCommandParameters, JsonTestContext.Default.CommandResponseMessageTestCommandResult);
        _ = Task.Run(async () =>
        {
            string json = """
                          {
    ...
    public async Task TestTransportGetResponseWithThrownException()
    {
        ...
        await command.WaitForCompletionAsync(TimeSpan.FromSeconds(250));
        Assert.That(command.ThrownException, Is.InstanceOf<BiDiException>().With.Message.Contains("Response did not contain properly formed JSON for response type"));
    }
    ...
    public void TestTransportCannotSendCommandWithoutConnection()
    {
        ...
        TestCommandParameters commandParameters = new(commandName);
        Assert.That(async () => await transport.SendCommandAsync(commandParameters, JsonTestContext.Default.TestCommandParameters, JsonTestContext.Default.CommandResponseMessageTestCommandResult), Throws.InstanceOf<BiDiException>().With.Message.Contains("Transport must be connected to a remote end to execute commands."));
    }
    ...
    public async Task TestTransportEventReceived()
    {
        ...
        TestConnection connection = new();
        Transport transport = new(connection);
        transport.RegisterEventMessage("protocol.event", JsonTestContext.Default.EventMessageTestEventArgs);
    ...
    public async Task TestTransportLogsMalformedJsonMessages()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(logs[0].Level, Is.EqualTo(BiDiLogLevel.Error));
        });
    }
    ...
    public async Task TestTransportCanUseDefaultConnection()
    {
        ...
        await transport.ConnectAsync(new Uri($"ws://localhost:{server.Port}"));
    ...
    public async Task TestCannotConnectWhenAlreadyConnected()
    {
        TestConnection connection = new();
        Transport transport = new(connection);
        await transport.ConnectAsync(new Uri($"ws://localhost:1234"));
        Assert.That(async () => await transport.ConnectAsync(new Uri($"ws://localhost:5678")), Throws.InstanceOf<BiDiException>().With.Message.StartsWith($"The transport is already connected to ws://localhost:1234"));
    }
    ...
    public async Task TestTransportCanReuseConnectionToDifferentUrl()
    {
        ...
        TestConnection connection = new();
        Transport transport = new(connection);
        await transport.ConnectAsync(new Uri("ws://example.com:1234"));
        ...
        await transport.ConnectAsync(new Uri("ws://example.com:5678"));
        _ = await transport.SendCommandAsync(command, JsonTestContext.Default.TestCommandParameters, JsonTestContext.Default.CommandResponseMessageTestCommandResult);
    ...
    public async Task TestExceptionInTransportEventReceivedCanCollect()
    {
        ...
        {
            syncEvent.Set();
            throw new BiDiException("This is an unexpected exception");
        });
        string json = """
                      {
                        "type": "event",
        ...
        await connection.RaiseDataReceivedEventAsync(json);
        syncEvent.WaitOne(TimeSpan.FromSeconds(1));
        Assert.That(async () => await transport.DisconnectAsync(), Throws.InstanceOf<BiDiException>().With.Message.Contains("Normal shutdown").And.InnerException.InstanceOf<BiDiException>().And.InnerException.Message.Contains("This is an unexpected exception"));
    }
    ...
    public async Task TestExceptionInTransportEventReceivedCanCollectMultiple()
    {
        ...
        await connection.RaiseDataReceivedEventAsync(json);
        syncEvent.WaitOne(TimeSpan.FromSeconds(1));
        Assert.That(async () => await transport.DisconnectAsync(), Throws.InstanceOf<AggregateException>().With.Message.Contains("Normal shutdown").And.Property("InnerExceptions").Count.EqualTo(2).And.Property("InnerExceptions").All.InstanceOf<BiDiException>().And.Message.Contains("This is an unexpected exception"));
    }
    ...
    public async Task TestExceptionInTransportEventReceivedCanTerminate()
    {
        ...
        string commandName = "module.command";
        TestCommandParameters commandParameters = new(commandName);
        Assert.That(async () => await transport.SendCommandAsync(commandParameters, JsonTestContext.Default.TestCommandParameters, JsonTestContext.Default.CommandResponseMessageTestCommandResult), Throws.InstanceOf<BiDiException>().With.Message.Contains("protocol.event").And.InnerException.InstanceOf<BiDiException>().And.InnerException.Message.Contains("This is an unexpected exception"));
    }
    ...
    public async Task TestCapturedExceptionsCanBeReset()
    {
        ...
        transport.OnEventReceived.AddObserver((EventReceivedEventArgs e) =>
        {
            return ValueTask.FromException(new BiDiException("This is an unexpected exception"));
        });
        string json = """
                      {
                        "type": "event",
        ...
        TestCommandParameters commandParameters = new(commandName);
        _ = await transport.SendCommandAsync(commandParameters, JsonTestContext.Default.TestCommandParameters, JsonTestContext.Default.CommandResponseMessageTestCommandResult);
