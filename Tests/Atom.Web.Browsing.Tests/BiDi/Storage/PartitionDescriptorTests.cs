...
public class PartitionDescriptorTests
{
    ...
    public void TestCanSerializeBrowsingContextPartitionDescriptor()
    {
        ...
        string json = JsonSerializer.Serialize(properties, JsonContext.Default.BrowsingContextPartitionDescriptor);
    ...
    public void TestCanSerializeStorageKeyPartitionDescriptor()
    {
        ...
        string json = JsonSerializer.Serialize(properties, JsonContext.Default.StorageKeyPartitionDescriptor);
        JObject serialized = JObject.Parse(json);
        Assert.Multiple(() =>
        {
