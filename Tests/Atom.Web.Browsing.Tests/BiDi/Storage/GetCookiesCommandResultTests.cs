...
public class GetCookiesCommandResultTests
{
    ...
    public void TestCanDeserialize()
    {
        ...
        string json = $$"""
                      ...
                      """;
        GetCookiesCommandResult? result = JsonSerializer.Deserialize<GetCookiesCommandResult>(json, JsonContext.Default.GetCookiesCommandResult);
        Assert.Multiple(() =>
        {
    ...
    public void TestDeserializingWithMissingCookiesThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<GetCookiesCommandResult>(json, JsonContext.Default.GetCookiesCommandResult), Throws.InstanceOf<JsonException>());
    }
