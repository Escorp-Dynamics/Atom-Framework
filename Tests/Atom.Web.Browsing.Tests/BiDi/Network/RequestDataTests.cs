...
public class RequestDataTests
{
    ...
    public void CanDeserializeRequestData()
    {
        string json = """
                      ...
                      """;
        RequestData? request = JsonSerializer.Deserialize<RequestData>(json, JsonContext.Default.RequestData);
        Assert.That(request, Is.Not.Null);
        Assert.Multiple(() =>
        {
            Assert.That(request!.RequestId, Is.EqualTo("myRequestId"));
            Assert.That(request!.Url.OriginalString, Is.EqualTo("requestUrl"));
    ...
    public void TestDeserializeWithMissingRequestIdThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<RequestData>(json, JsonContext.Default.RequestData), Throws.InstanceOf<JsonException>().With.Message.Contains("was missing required properties including: 'request'"));
    }
    ...
    public void TestDeserializeWithMissingUrlThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<RequestData>(json, JsonContext.Default.RequestData), Throws.InstanceOf<JsonException>().With.Message.Contains("was missing required properties including: 'url'"));
    }
    ...
    public void TestDeserializeWithMissingMethodThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<RequestData>(json, JsonContext.Default.RequestData), Throws.InstanceOf<JsonException>().With.Message.Contains("was missing required properties including: 'method'"));
    }
    ...
    public void TestDeserializeWithMissingHeadersThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<RequestData>(json, JsonContext.Default.RequestData), Throws.InstanceOf<JsonException>().With.Message.Contains("was missing required properties including: 'headers'"));
    }
    ...
    public void TestDeserializeWithMissingCookiesThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<RequestData>(json, JsonContext.Default.RequestData), Throws.InstanceOf<JsonException>().With.Message.Contains("was missing required properties including: 'cookies'"));
    }
    ...
    public void TestDeserializeWithMissingHeadersSizeThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<RequestData>(json, JsonContext.Default.RequestData), Throws.InstanceOf<JsonException>().With.Message.Contains("was missing required properties including: 'headersSize'"));
    }
    ...
    public void TestDeserializeWithMissingBodySizeThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<RequestData>(json, JsonContext.Default.RequestData), Throws.InstanceOf<JsonException>().With.Message.Contains("was missing required properties including: 'bodySize'"));
    }
    ...
    public void TestDeserializeWithMissingDestinationThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<RequestData>(json, JsonContext.Default.RequestData), Throws.InstanceOf<JsonException>().With.Message.Contains("was missing required properties including: 'destination'"));
    }
    ...
    public void TestDeserializeWithMissingInitiatorTypeThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<RequestData>(json, JsonContext.Default.RequestData), Throws.InstanceOf<JsonException>().With.Message.Contains("was missing required properties including: 'initiatorType'"));
    }
    ...
    public void TestDeserializeWithMissingTimingsThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<RequestData>(json, JsonContext.Default.RequestData), Throws.InstanceOf<JsonException>().With.Message.Contains("was missing required properties including: 'timings'"));
    }
}
