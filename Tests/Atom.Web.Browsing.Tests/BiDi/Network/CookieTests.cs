...
public class CookieTests
{
    ...
    public void TestCanDeserializeCookie()
    {
        string json = """
                      ...
                      """;
        Cookie? cookie = JsonSerializer.Deserialize<Cookie>(json, JsonContext.Default.Cookie);
    ...
    public void TestDeserializeWithMissingNameThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<Cookie>(json, JsonContext.Default.Cookie), Throws.InstanceOf<JsonException>().With.Message.Contains("was missing required properties including: 'name'"));
    }
    ...
    public void TestDeserializeWithMissingValueThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<Cookie>(json, JsonContext.Default.Cookie), Throws.InstanceOf<JsonException>().With.Message.Contains("was missing required properties including: 'value'"));
    }
    ...
    public void TestDeserializeWithMissingDomainThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<Cookie>(json, JsonContext.Default.Cookie), Throws.InstanceOf<JsonException>().With.Message.Contains("was missing required properties including: 'domain'"));
    }
    ...
    public void TestDeserializeWithMissingPathThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<Cookie>(json, JsonContext.Default.Cookie), Throws.InstanceOf<JsonException>().With.Message.Contains("was missing required properties including: 'path'"));
    }
    ...
    public void TestDeserializeWithMissingSecureThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<Cookie>(json, JsonContext.Default.Cookie), Throws.InstanceOf<JsonException>().With.Message.Contains("was missing required properties including: 'secure'"));
    }
    ...
    public void TestDeserializeWithMissingHttpOnlyThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<Cookie>(json, JsonContext.Default.Cookie), Throws.InstanceOf<JsonException>().With.Message.Contains("was missing required properties including: 'httpOnly'"));
    }
    ...
    public void TestDeserializeWithMissingSameSiteThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<Cookie>(json, JsonContext.Default.Cookie), Throws.InstanceOf<JsonException>().With.Message.Contains("was missing required properties including: 'sameSite'"));
    }
    ...
    public void TestDeserializeWithMissingSizeThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<Cookie>(json, JsonContext.Default.Cookie), Throws.InstanceOf<JsonException>().With.Message.Contains("was missing required properties including: 'size'"));
    }
    ...
    public void TestDeserializeWithInvalidSameSiteValueThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<Cookie>(json, JsonContext.Default.Cookie), Throws.InstanceOf<BiDiException>().With.Message.Contains("значение 'invalid' недопустимо для типа перечисления"));
    }
}
