...
public class ResponseStartedEventArgsTests
{
    ...
    public void TestCanDeserialize()
    {
        ...
        string eventJson = $$"""
                           ...
                           """;
        ResponseStartedEventArgs? eventArgs = JsonSerializer.Deserialize<ResponseStartedEventArgs>(eventJson, JsonContext.Default.ResponseStartedEventArgs);
    ...
    public void TestDeserializeWithMissingResponseThrows()
    {
        ...
        string eventJson = $$"""
                           ...
                           """;
        Assert.That(() => JsonSerializer.Deserialize<ResponseStartedEventArgs>(eventJson, JsonContext.Default.ResponseStartedEventArgs), Throws.InstanceOf<JsonException>());
    }
}
