...
public class AuthChallengeTests
{
    ...
    public void TestCanDeserializeAuthChallenge()
    {
        string json = """
                      ...
                      """;
        AuthChallenge? challenge = JsonSerializer.Deserialize<AuthChallenge>(json, JsonContext.Default.AuthChallenge);
    ...
    public void TestDeserializingWithMissingSchemeThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<AuthChallenge>(json, JsonContext.Default.AuthChallenge), Throws.InstanceOf<JsonException>());
    }
