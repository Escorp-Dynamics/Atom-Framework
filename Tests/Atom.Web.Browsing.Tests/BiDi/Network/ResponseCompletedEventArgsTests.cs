...
public class ResponseCompletedEventArgsTests
{
    ...
    public void TestCanDeserialize()
    {
        ...
        string eventJson = $$"""
                           ...
                           """;
        ResponseCompletedEventArgs? eventArgs = JsonSerializer.Deserialize<ResponseCompletedEventArgs>(eventJson, JsonContext.Default.ResponseCompletedEventArgs);
    ...
    public void TestDeserializeWithMissingResponseThrows()
    {
        ...
        string eventJson = $$"""
                           ...
                           """;
        Assert.That(() => JsonSerializer.Deserialize<ResponseCompletedEventArgs>(eventJson, JsonContext.Default.ResponseCompletedEventArgs), Throws.InstanceOf<JsonException>());
    }
}
