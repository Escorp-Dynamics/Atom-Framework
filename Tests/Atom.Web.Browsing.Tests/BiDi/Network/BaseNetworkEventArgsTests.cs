...
public class BaseNetworkEventArgsTests
{
    ...
    public void TestCanDeserialize()
    {
        ...
        string eventJson = $$"""
                           ...
                           """;
        BaseNetworkEventArgs? eventArgs = JsonSerializer.Deserialize<BaseNetworkEventArgs>(eventJson, JsonContext.Default.BaseNetworkEventArgs);
    ...
    public void TestDeserializingWithMissingContextIdThrows()
    {
        ...
        string eventJson = $$"""
                           ...
                           """;
        Assert.That(() => JsonSerializer.Deserialize<BaseNetworkEventArgs>(eventJson, JsonContext.Default.BaseNetworkEventArgs), Throws.InstanceOf<JsonException>());
    }
