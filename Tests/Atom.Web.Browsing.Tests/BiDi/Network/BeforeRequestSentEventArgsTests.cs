...
public class BeforeRequestSentEventArgsTests
{
    ...
    public void TestCanDeserialize()
    {
        ...
        string eventJson = $$"""
                           ...
                           """;
        BeforeRequestSentEventArgs? eventArgs = JsonSerializer.Deserialize<BeforeRequestSentEventArgs>(eventJson, JsonContext.Default.BeforeRequestSentEventArgs);
    ...
    public void TestDeserializingWithInvalidInitiatorTypeThrows()
    {
        ...
        string eventJson = $$"""
                           ...
                           """;
        Assert.That(() => JsonSerializer.Deserialize<BeforeRequestSentEventArgs>(eventJson, JsonContext.Default.BeforeRequestSentEventArgs), Throws.InstanceOf<JsonException>());
    }
}
