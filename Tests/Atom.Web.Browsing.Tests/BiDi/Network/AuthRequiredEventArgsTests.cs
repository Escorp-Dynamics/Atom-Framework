...
public class AuthRequiredEventArgsTests
{
    ...
    public void TestCanDeserialize()
    {
        ...
        string eventJson = $$"""
                           ...
                           """;
        AuthRequiredEventArgs? eventArgs = JsonSerializer.Deserialize<AuthRequiredEventArgs>(eventJson, JsonContext.Default.AuthRequiredEventArgs);
    ...
    public void TestDeserializingWithMissingResponseThrows()
    {
        ...
        string eventJson = $$"""
                           ...
                           """;
        Assert.That(() => JsonSerializer.Deserialize<AuthRequiredEventArgs>(eventJson, JsonContext.Default.AuthRequiredEventArgs), Throws.InstanceOf<JsonException>());
    }
}
