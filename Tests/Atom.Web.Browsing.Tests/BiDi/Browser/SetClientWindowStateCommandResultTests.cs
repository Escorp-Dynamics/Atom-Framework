...
public class SetClientWindowStateCommandResultTests
{
    ...
    public void TestCanDeserialize()
    {
        string json = """
                      ...
                      """;
        SetClientWindowStateCommandResult? result = JsonSerializer.Deserialize<SetClientWindowStateCommandResult>(json, JsonContext.Default.SetClientWindowStateCommandResult);
    ...
    public void TestDeserializingWithMissingWindowIdThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<SetClientWindowStateCommandResult>(json, JsonContext.Default.SetClientWindowStateCommandResult), Throws.InstanceOf<JsonException>());
    }
    ...
    public void TestDeserializingWithInvalidStateValueThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<SetClientWindowStateCommandResult>(json, JsonContext.Default.SetClientWindowStateCommandResult), Throws.InstanceOf<BiDiException>());
    }
