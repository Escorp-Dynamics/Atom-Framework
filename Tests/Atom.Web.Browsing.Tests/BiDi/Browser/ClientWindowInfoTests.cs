...
public class ClientWindowsInfoTests
{
    ...
    public void TestCanDeserialize()
    {
        string json = """
                      ...
                      """;
        ClientWindowInfo? result = JsonSerializer.Deserialize(json, JsonContext.Default.ClientWindowInfo);
    ...
    public void TestDeserializingWithMissingWindowIdThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize(json, JsonContext.Default.ClientWindowInfo), Throws.InstanceOf<JsonException>());
    }
    ...
    public void TestDeserializingWithInvalidWindowIdDataTypeThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<ClientWindowInfo>(json, JsonContext.Default.ClientWindowInfo), Throws.InstanceOf<JsonException>());
    }
    ...
    public void TestCanDeserializeWithMaximizedState()
    {
        string json = """
                      ...
                      """;
        ClientWindowInfo? result = JsonSerializer.Deserialize<ClientWindowInfo>(json, JsonContext.Default.ClientWindowInfo);
        Assert.That(result, Is.Not.Null);
        Assert.Multiple(() =>
        {
            Assert.That(result.ClientWindowId, Is.EqualTo("myClientWindow"));
    ...
    public void TestDeserializingWithInvalidStateValueThrows()
    {
        string json = """
                      ...
                      """;
        Assert.That(() => JsonSerializer.Deserialize<ClientWindowInfo>(json, JsonContext.Default.ClientWindowInfo), Throws.InstanceOf<BiDiException>());
    }
