...
public class OriginTests
{
    ...
    public void TestCanSerializeViewportOrigin()
    {
        ...
        string json = JsonSerializer.Serialize(origin.Value, JsonContext.Default.String);
        string? parsed = JsonSerializer.Deserialize(json, JsonContext.Default.String);
    ...
    public void TestCanSerializeElementOrigin()
    {
        string nodeJson = """
                          ...
                          """;
        SharedReference node = JsonSerializer.Deserialize(nodeJson, JsonContext.Default.RemoteValue)!.ToSharedReference();
        
        ElementOrigin elementOrigin = new(node);
        Origin origin = Origin.Element(elementOrigin);
        string json = JsonSerializer.Serialize(origin.Value, JsonContext.Default.ElementOrigin);
