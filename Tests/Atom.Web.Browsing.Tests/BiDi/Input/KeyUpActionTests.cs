...
public class KeyUpActionTests
{
    ...
    public void TestCanSerializeParameters()
    {
        ...
        string json = JsonSerializer.Serialize(properties, JsonContext.Default.KeyUpAction);
    ...
    {
        Assert.That(() => new KeyUpAction(string.Empty), Throws.InstanceOf<ArgumentException>().With.Message.Contains("Значение действия не может быть null или пустой строкой"));
    }
}
