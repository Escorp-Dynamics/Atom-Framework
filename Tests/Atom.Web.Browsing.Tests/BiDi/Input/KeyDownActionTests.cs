...
public class KeyDownActionTests
{
    ...
    public void TestCanSerializeParameters()
    {
        ...
        string json = JsonSerializer.Serialize(properties, JsonContext.Default.KeyDownAction);
    ...
    {
        Assert.That(() => new KeyDownAction(string.Empty), Throws.InstanceOf<ArgumentException>().With.Message.Contains("Значение действия не может быть null или пустой строкой"));
    }
}
