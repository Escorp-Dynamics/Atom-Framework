...
public partial interface ILogger
{
    ...
    /// <param name="cancellationToken">Токен отмены задачи.</param>
    /// <returns></returns>
    ValueTask DebugAsync<T>(string? message, string messageForFile, ConsoleColor color, T? data, CancellationToken cancellationToken);
    ...
    /// <param name="data">Связанные данные.</param>
    /// <returns></returns>
    ValueTask DebugAsync<T>(string? message, string messageForFile, ConsoleColor color, T? data) => DebugAsync(message, messageForFile, color, data, CancellationToken.None);
    ...
    /// <param name="cancellationToken">Токен отмены задачи.</param>
    /// <returns></returns>
    ValueTask DebugAsync<T>(string? message, string messageForFile, T? data, CancellationToken cancellationToken) => DebugAsync(message, messageForFile, ConsoleColor.Gray, data, cancellationToken);
    ...
    /// <param name="data">Связанные данные.</param>
    /// <returns></returns>
    ValueTask DebugAsync<T>(string? message, string messageForFile, T? data) => DebugAsync(message, messageForFile, data, CancellationToken.None);
    ...
    /// <param name="cancellationToken">Токен отмены задачи.</param>
    /// <returns></returns>
    ValueTask DebugAsync(string? message, string messageForFile, ConsoleColor color, CancellationToken cancellationToken);
    ...
    /// <param name="color">Цвет текста записи.</param>
    /// <returns></returns>
    ValueTask DebugAsync(string? message, string messageForFile, ConsoleColor color) => DebugAsync(message, messageForFile, color, CancellationToken.None);
    ...
    /// <param name="cancellationToken">Токен отмены задачи.</param>
    /// <returns></returns>
    ValueTask DebugAsync(string? message, string messageForFile, CancellationToken cancellationToken) => DebugAsync(message, messageForFile, ConsoleColor.Gray, cancellationToken);
    ...
    /// <param name="messageForFile">Сообщение журнала (для записи в файл).</param>
    /// <returns></returns>
    ValueTask DebugAsync(string? message, string messageForFile) => DebugAsync(message, messageForFile, CancellationToken.None);
}