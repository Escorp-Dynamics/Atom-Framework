...
public partial interface ILogger
{
    ...
    /// <param name="cancellationToken">Токен отмены задачи.</param>
    /// <returns></returns>
    ValueTask CriticalAsync<T>(string? message, string messageForFile, ConsoleColor color, T? data, CancellationToken cancellationToken);
    ...
    /// <param name="data">Связанные данные.</param>
    /// <returns></returns>
    ValueTask CriticalAsync<T>(string? message, string messageForFile, ConsoleColor color, T? data) => CriticalAsync(message, messageForFile, color, data, CancellationToken.None);
    ...
    /// <param name="cancellationToken">Токен отмены задачи.</param>
    /// <returns></returns>
    ValueTask CriticalAsync<T>(string? message, string messageForFile, T? data, CancellationToken cancellationToken) => CriticalAsync(message, messageForFile, ConsoleColor.Magenta, data, cancellationToken);
    ...
    /// <param name="data">Связанные данные.</param>
    /// <returns></returns>
    ValueTask CriticalAsync<T>(string? message, string messageForFile, T? data) => CriticalAsync(message, messageForFile, data, CancellationToken.None);
    ...
    /// <param name="cancellationToken">Токен отмены задачи.</param>
    /// <returns></returns>
    ValueTask CriticalAsync(string? message, string messageForFile, ConsoleColor color, Exception ex, CancellationToken cancellationToken);
    ...
    /// <param name="ex">Информация об ошибке.</param>
    /// <returns></returns>
    ValueTask CriticalAsync(string? message, string messageForFile, ConsoleColor color, Exception ex) => CriticalAsync(message, messageForFile, color, ex, CancellationToken.None);
    ...
    /// <param name="cancellationToken">Токен отмены задачи.</param>
    /// <returns></returns>
    ValueTask CriticalAsync(string? message, string messageForFile, Exception ex, CancellationToken cancellationToken) => CriticalAsync(message, messageForFile, ConsoleColor.Magenta, ex, cancellationToken);
    ...
    /// <param name="ex">Информация об ошибке.</param>
    /// <returns></returns>
    ValueTask CriticalAsync(string? message, string messageForFile, Exception ex) => CriticalAsync(message, messageForFile, ex, CancellationToken.None);
    ...
    /// <param name="cancellationToken">Токен отмены задачи.</param>
    /// <returns></returns>
    ValueTask CriticalAsync(string? message, string messageForFile, ConsoleColor color, CancellationToken cancellationToken);
    ...
    /// <param name="color">Цвет текста записи.</param>
    /// <returns></returns>
    ValueTask CriticalAsync(string? message, string messageForFile, ConsoleColor color) => CriticalAsync(message, messageForFile, color, CancellationToken.None);
    ...
    /// <param name="cancellationToken">Токен отмены задачи.</param>
    /// <returns></returns>
    ValueTask CriticalAsync(string? message, string messageForFile, CancellationToken cancellationToken) => CriticalAsync(message, messageForFile, ConsoleColor.Magenta, cancellationToken);
    ...
    /// <param name="messageForFile">Сообщение журнала (для записи в файл).</param>
    /// <returns></returns>
    ValueTask CriticalAsync(string? message, string messageForFile) => CriticalAsync(message, messageForFile, CancellationToken.None);
}