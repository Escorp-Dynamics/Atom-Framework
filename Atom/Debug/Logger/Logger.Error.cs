...
public partial class Logger
{
    ...
    {
        Add(message, mode, LogType.Error, color, data);
    ...
    /// <inheritdoc/>
    public virtual ValueTask ErrorAsync<T>(string? message, string messageForFile, ConsoleColor color, T? data, CancellationToken cancellationToken)
    {
        AddToConsole(message, LogType.Error, color, data);
        AddToFileFormatted(messageForFile, LogType.Error, data);
        return ValueTask.CompletedTask;
    }

    /// <inheritdoc/>
    public ValueTask ErrorAsync<T>(string? message, string messageForFile, ConsoleColor color, T? data) => ErrorAsync(message, messageForFile, color, data, CancellationToken.None);

    /// <inheritdoc/>
    public ValueTask ErrorAsync<T>(string? message, string messageForFile, T? data, CancellationToken cancellationToken) => ErrorAsync(message, messageForFile, ConsoleColor.Red, data, cancellationToken);

    /// <inheritdoc/>
    public ValueTask ErrorAsync<T>(string? message, string messageForFile, T? data) => ErrorAsync(message, messageForFile, data, CancellationToken.None);
    ...
    /// <inheritdoc/>
    public virtual ValueTask ErrorAsync(string? message, string messageForFile, ConsoleColor color, Exception ex, CancellationToken cancellationToken) => ErrorAsync(message, messageForFile, color, ex?.ToDictionary(), cancellationToken);

    /// <inheritdoc/>
    public ValueTask ErrorAsync(string? message, string messageForFile, ConsoleColor color, Exception ex) => ErrorAsync(message, messageForFile, color, ex, CancellationToken.None);

    /// <inheritdoc/>
    public ValueTask ErrorAsync(string? message, string messageForFile, Exception ex, CancellationToken cancellationToken) => ErrorAsync(message, messageForFile, ConsoleColor.Red, ex, cancellationToken);

    /// <inheritdoc/>
    public ValueTask ErrorAsync(string? message, string messageForFile, Exception ex) => ErrorAsync(message, messageForFile, ex, CancellationToken.None);
    ...
    /// <inheritdoc/>
    public virtual ValueTask ErrorAsync(string? message, string messageForFile, ConsoleColor color, CancellationToken cancellationToken) => ErrorAsync<object>(message, messageForFile, color, default, cancellationToken);

    /// <inheritdoc/>
    public ValueTask ErrorAsync(string? message, string messageForFile, ConsoleColor color) => ErrorAsync(message, messageForFile, color, CancellationToken.None);

    /// <inheritdoc/>
    public ValueTask ErrorAsync(string? message, string messageForFile, CancellationToken cancellationToken) => ErrorAsync(message, messageForFile, ConsoleColor.Red, cancellationToken);

    /// <inheritdoc/>
    public ValueTask ErrorAsync(string? message, string messageForFile) => ErrorAsync(message, messageForFile, CancellationToken.None);
}