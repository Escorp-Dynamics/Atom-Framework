...
public partial interface ILogger
{
    ...
    /// <param name="cancellationToken">Токен отмены задачи.</param>
    /// <returns></returns>
    ValueTask InfoAsync<T>(string? message, string messageForFile, ConsoleColor color, T? data, CancellationToken cancellationToken);
    ...
    /// <param name="data">Связанные данные.</param>
    /// <returns></returns>
    ValueTask InfoAsync<T>(string? message, string messageForFile, ConsoleColor color, T? data) => InfoAsync(message, messageForFile, color, data, CancellationToken.None);
    ...
    /// <param name="cancellationToken">Токен отмены задачи.</param>
    /// <returns></returns>
    ValueTask InfoAsync<T>(string? message, string messageForFile, T? data, CancellationToken cancellationToken) => InfoAsync(message, messageForFile, ConsoleColor.White, data, cancellationToken);
    ...
    /// <param name="data">Связанные данные.</param>
    /// <returns></returns>
    ValueTask InfoAsync<T>(string? message, string messageForFile, T? data) => InfoAsync(message, messageForFile, data, CancellationToken.None);
    ...
    /// <param name="cancellationToken">Токен отмены задачи.</param>
    /// <returns></returns>
    ValueTask InfoAsync(string? message, string messageForFile, ConsoleColor color, CancellationToken cancellationToken);
    ...
    /// <param name="color">Цвет текста записи.</param>
    /// <returns></returns>
    ValueTask InfoAsync(string? message, string messageForFile, ConsoleColor color) => InfoAsync(message, messageForFile, color, CancellationToken.None);
    ...
    /// <param name="cancellationToken">Токен отмены задачи.</param>
    /// <returns></returns>
    ValueTask InfoAsync(string? message, string messageForFile, CancellationToken cancellationToken) => InfoAsync(message, messageForFile, ConsoleColor.White, cancellationToken);
    ...
    /// <param name="messageForFile">Сообщение журнала (для записи в файл).</param>
    /// <returns></returns>
    ValueTask InfoAsync(string? message, string messageForFile) => InfoAsync(message, messageForFile, CancellationToken.None);
}