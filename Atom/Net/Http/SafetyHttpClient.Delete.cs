...
public partial class SafetyHttpClient
{
    ...
    public virtual async ValueTask<HttpResponseMessage> DeleteAsync(Uri url, IReadOnlyDictionary<string, string>? headers, Version version, HttpCompletionOption completionOption, CancellationToken cancellationToken)
    {
    ...
    public async ValueTask<TResponse?> DeleteAsync<TResponse>(Uri url, IReadOnlyDictionary<string, string>? headers, Version version, JsonTypeInfo<TResponse> responseTypeInfo, CancellationToken cancellationToken)
    {
    ...
    public async IAsyncEnumerable<TResponse?> DeleteAsyncEnumerable<TResponse>(Uri url, IReadOnlyDictionary<string, string>? headers, Version version, JsonTypeInfo<TResponse> responseTypeInfo, [EnumeratorCancellation] CancellationToken cancellationToken)
    {
        using var request = new HttpRequestMessage(HttpMethod.Delete, url);
