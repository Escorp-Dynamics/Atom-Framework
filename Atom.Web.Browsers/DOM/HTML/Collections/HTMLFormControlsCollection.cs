...
/// </summary>
public class HTMLFormControlsCollection : HTMLCollection, IHTMLFormControlsCollection
{
    /// <inheritdoc/>
    ...
    public new object? NamedItem(string name)
    {
        ...
        return namedElements.Length is 0 ? default : namedElements.Length is 1 ? namedElements[0] : new RadioNodeList(namedElements);
    }
}