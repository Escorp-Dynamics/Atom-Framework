...
{
    public static void WriteVideoFrame(CodecContext* context, FormatContext* outputContext, int streamIndex, ref long videoPts, SemaphoreSlim? locker)
    {
    ...
    public static void WriteAudioFrame(CodecContext* context, FormatContext* outputContext, int streamIndex, ref long audioPts, SemaphoreSlim? locker)
    {
        var frame = FFmpeg.Util.FrameAlloc();
    ...
    private static void GenerateWhiteNoiseVideo(CodecContext* context, MediaFrame* frame, SemaphoreSlim? locker)
    {
