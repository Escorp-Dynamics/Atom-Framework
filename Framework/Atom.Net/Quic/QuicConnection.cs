...
public sealed class QuicConnection : IAsyncDisposable
{
    ...
    /// </summary>
    /// <remarks>
    /// Параметр <c>initial_source_connection_id</c> обязан ПОБАЙТНО совпадать с идентификатором
    ...
    /// <remarks>
    /// Следующее поколение выводится из ТЕКУЩЕГО секрета меткой <c>quic ku</c> (RFC 9001, §6.1),
