...
internal sealed partial class Https11Connection
{
    ...
    /// </summary>
    /// <remarks>
    /// ★ Раньше массив выделялся ровно по <c lang="text">Content-Length</c>, каким бы тот ни был. Заявленной
    /// длине верить нельзя: она приходит от чужой стороны, и одного узла из тысячи с
    /// <c lang="text">Content-Length: 1500000000</c> — зеркала, сломанного CDN или намеренной ловушки —
    ...
    /// форма HTTP/1.1: ни <c lang="text">Content-Length</c>, ни кусочной передачи в нём нет, и конец тела
