...
// Состав: точные суффиксы (включая punycode xn-- для IDN), базы wildcard-правил (*.ck → база "ck")
// и exception-правила (!www.ck → "www.ck").
// </auto-generated>
...
{
    internal static readonly HashSet<string> Exact = new(StringComparer.OrdinalIgnoreCase)
    {
        "0.bg",
        "1.bg",
        "2.bg",
    ...
    internal static readonly HashSet<string> WildcardBases = new(StringComparer.OrdinalIgnoreCase)
    {
        "ck",
        "er",
        "fk",
    ...
    internal static readonly HashSet<string> Exceptions = new(StringComparer.OrdinalIgnoreCase)
    {
        "city.kawasaki.jp",
        "city.kitakyushu.jp",
        "city.kobe.jp",
