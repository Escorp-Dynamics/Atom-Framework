...
/// <summary>
/// Представляет расширения для <see cref="Https"/>.
/// </summary>
public static class HttpsExtensions
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static FormUrlEncodedContent AsFormUrlEncodedContent([NotNull] this string body)
    => new(body.Split('&', StringSplitOptions.RemoveEmptyEntries | StringSplitOptions.TrimEntries)
        .Select(p => p.Split('=', 2))
