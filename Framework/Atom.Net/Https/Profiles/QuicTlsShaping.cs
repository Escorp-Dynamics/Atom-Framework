...
/// сам транспорт: <c lang="text">h3</c> в ALPN, только TLS 1.3 в supported_versions, пустой идентификатор
...
/// та же роль отдана транспорту — подставная версия в <c lang="text">version_information</c> и подставный
...
public static class QuicTlsShaping
{
    ...
    [
        ...
        0xCA34,  // trust_anchors — в снятом приветствии QUIC его нет, хотя поверх TCP он есть
    ];
