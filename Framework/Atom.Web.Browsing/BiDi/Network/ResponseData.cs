...
public class ResponseData
{
    ...
    [JsonRequired]
    [JsonInclude]
    public Uri Url { get; internal set; } = new Uri("about:blank");
    ...
    [JsonRequired]
    [JsonInclude]
    public ResponseContent Content { get; internal set; } = new();
    ...
    [JsonInclude]
    public IList<AuthChallenge>? AuthChallenges { get; internal set; }
