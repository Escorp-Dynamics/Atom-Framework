...
public class NodeProperties
{
    ...
    /// </summary>
    [JsonIgnore]
    public IList<RemoteValue>? Children => SerializableChildren?.AsReadOnly();
    ...
    public NodeAttributes? Attributes
    {
        get
        {
            if (SerializableAttributes is null) return null;
            field ??= new NodeAttributes(SerializableAttributes);
            return field;
        }
    }
