...
await build({
    entryPoints: [path.join(extensionRuntimeDirectory, 'identity.runtime.ts')],
    outfile: path.join(generatedDirectory, 'identity.main.js'),
    bundle: true,
    format: 'iife',
    platform: 'browser',
    target: ['es2022'],
...
console.info('[extension-runtime] Собран ранний скрипт личности generated/identity.main.js');
