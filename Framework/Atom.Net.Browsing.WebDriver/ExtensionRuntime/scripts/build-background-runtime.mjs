...
await build({
    entryPoints: [path.join(extensionRuntimeDirectory, 'background.runtime.ts')],
    outfile: path.join(generatedDirectory, 'background.runtime.js'),
    bundle: true,
    format: 'iife',
    platform: 'browser',
    target: ['es2022'],
...
console.info('[extension-runtime] Собран фоновый вход generated/background.runtime.js');
