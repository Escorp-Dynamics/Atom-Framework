...
internal static class PlatformFontConfiguration
{
    ...
    /// </summary>
    /// <remarks>
    /// Ищем файлы, а не спрашиваем fontconfig: запуск <c>fc-match</c> добавил бы зависимость от
    ...
    /// свои: страница видела одновременно <c>Helvetica Neue</c>, <c>Geneva</c> — и рядом
    /// <c>DejaVu Sans</c>, <c>Liberation Sans</c>, <c>Noto Sans</c>, <c>Cantarell</c>. Ни одного
    ...
    /// <param name="families">Пары «заявленное семейство — донор».</param>
    /// <remarks>
    /// ★ Без этого <c>sans-serif</c>, <c>serif</c> и <c>monospace</c> после сокрытия системных
