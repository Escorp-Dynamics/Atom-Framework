...
/// <c>tabs.update</c> умеет только GET. Единственный честный способ заставить браузер сделать
/// POST на целевой адрес — отдать ему страницу с формой <c>method="post"</c>, которая
...
/// <para>
/// Поддерживается только <c>application/x-www-form-urlencoded</c>: форма кодирует поля именно
