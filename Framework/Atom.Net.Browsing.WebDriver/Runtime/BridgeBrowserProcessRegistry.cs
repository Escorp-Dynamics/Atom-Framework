...
/// «стоп» в отладчике, падение) <c lang="text">DisposeAsync</c> не вызывается, и браузер + его временный
...
internal static class BridgeBrowserProcessRegistry
{
    ...
    /// при смерти владельца (в т.ч. SIGKILL из отладчика, когда <c lang="text">DisposeAsync</c> не вызывается)
