...
/// </summary>
/// <remarks>
/// Расширение приводит результат скрипта к строке (<c lang="text">String(result)</c>) прежде, чем отправить его
/// в мост, поэтому логическое значение приходит как <c lang="text">"true"</c>, а число — как <c lang="text">"42"</c>, а не
/// литералами JSON. Прямые <c lang="text">JsonElement.GetBoolean</c>/<c lang="text">TryGetInt32</c>/<c lang="text">TryGetDouble</c> на
