...
public interface IPooled
{
    ...
    static abstract T Rent<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicParameterlessConstructor)] T>() where T : IPooled;
    ...
    /// <typeparam name="T">Тип экземпляра.</typeparam>
    static abstract void Return<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicParameterlessConstructor)] T>(T value) where T : IPooled;
}