...
public static class TextExtensions
{
    ...
    /// </summary>
    /// <param name="source">Исходная строка.</param>
    /// <param name="removeFormatting">Указывает, требуется ли удалить форматирование полностью.</param>
    public static string? ToUnixStyleFormat(this string? source, bool removeFormatting) => UnixStyleFormatter.Format(source, removeFormatting);

    /// <summary>
    /// Форматирует исходную строку в итоговый формат стилей UNIX.
    /// </summary>
    /// <param name="source">Исходная строка.</param>
    public static string? ToUnixStyleFormat(this string? source) => source.ToUnixStyleFormat(default);
}