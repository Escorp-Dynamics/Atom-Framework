...
/// <summary>
/// Представляет атрибут сериализации JSON.
/// </summary>
...
public sealed class JsonContextAttribute : Attribute
{
    ...
    /// <summary>
    /// Constructs a new <see cref="JsonContextAttribute"/> instance.
    /// </summary>
    public JsonContextAttribute() { }

    /// <summary>
    /// Constructs a new <see cref="JsonContextAttribute"/> instance with a predefined set of options determined by the specified <see cref="JsonSerializerDefaults"/>.
    /// </summary>
    ...
    public JsonContextAttribute(JsonSerializerDefaults defaults)
    {
