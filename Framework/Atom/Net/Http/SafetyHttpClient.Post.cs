...
public partial class SafetyHttpClient
{
    ...
    public virtual async ValueTask<HttpResponseMessage> PostAsync(Uri url, HttpContent content, IReadOnlyDictionary<string, string>? headers, Version version, HttpCompletionOption completionOption, CancellationToken cancellationToken)
    {
    ...
    public async ValueTask<TResponse?> PostAsync<TResponse>(Uri url, HttpContent content, IReadOnlyDictionary<string, string>? headers, Version version, JsonTypeInfo<TResponse> responseTypeInfo, CancellationToken cancellationToken)
    {
        using var request = new HttpRequestMessage(HttpMethod.Post, url);
    ...
    public async IAsyncEnumerable<TResponse?> PostAsyncEnumerable<TResponse>(Uri url, HttpContent content, IReadOnlyDictionary<string, string>? headers, Version version, JsonTypeInfo<TResponse> responseTypeInfo,
