...
public partial class SafetyHttpClient
{
    ...
    public virtual async ValueTask<HttpResponseMessage> PatchAsync(Uri url, HttpContent content, IReadOnlyDictionary<string, string>? headers, Version version, HttpCompletionOption completionOption, CancellationToken cancellationToken)
    {
    ...
    public async ValueTask<TResponse?> PatchAsync<TResponse>(Uri url, HttpContent content, IReadOnlyDictionary<string, string>? headers, Version version, JsonTypeInfo<TResponse> responseTypeInfo, CancellationToken cancellationToken)
    {
        using var request = new HttpRequestMessage(HttpMethod.Patch, url);
    ...
    public async IAsyncEnumerable<TResponse?> PatchAsyncEnumerable<TResponse>(Uri url, HttpContent content, IReadOnlyDictionary<string, string>? headers, Version version, JsonTypeInfo<TResponse> responseTypeInfo,
