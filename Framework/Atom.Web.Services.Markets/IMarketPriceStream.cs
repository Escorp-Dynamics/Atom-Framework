...
/// <summary>
/// Расширение потока цен с возможностью обновления кеша снимками.
/// </summary>
public interface IWritableMarketPriceStream : IMarketPriceStream
{
    /// <summary>
    /// Записывает или обновляет снимок цены для актива.
    /// </summary>
    void SetPrice(string assetId, IMarketPriceSnapshot snapshot);
}
