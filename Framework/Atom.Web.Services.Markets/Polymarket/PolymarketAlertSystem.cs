    ...
    : IMarketAlertDefinition
{
    ...
    // IMarketAlertDefinition не должен зависеть от порядка значений enum.
    AlertCondition IMarketAlertDefinition.Condition => Condition switch
    {
        PolymarketAlertCondition.PnLThreshold => AlertCondition.PnLThreshold,
        PolymarketAlertCondition.PriceThreshold => AlertCondition.PriceThreshold,
