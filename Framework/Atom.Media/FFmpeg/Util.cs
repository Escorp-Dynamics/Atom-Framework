...
internal static partial class FFmpeg
{
    public static unsafe partial class Util
    {
        ...
        [LibraryImport(Dll, EntryPoint = "av_strdup", SetLastError = true)]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        [DefaultDllImportSearchPaths(DllImportSearchPath.SafeDirectories)]
        public static partial char* StrDup([MarshalAs(UnmanagedType.LPStr)] string? str);

        [LibraryImport(Dll, EntryPoint = "av_frame_copy", SetLastError = true)]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        [DefaultDllImportSearchPaths(DllImportSearchPath.SafeDirectories)]
        public static partial int FrameCopy(MediaFrame* dst, MediaFrame* src);
    ...
    public static int ThrowIfErrors(this int errorCode, string message, Locker? locker)
    {
