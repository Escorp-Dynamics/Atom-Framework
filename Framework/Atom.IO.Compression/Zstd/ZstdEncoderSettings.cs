...
internal readonly struct ZstdEncoderSettings
{
    ...
    public ReadOnlyMemory<byte> DictionaryContent { get; init; }

    public bool UseDictTablesForSequences { get; init; }

    public bool UseDictHuffmanForLiterals { get; init; }

    public bool UseInterBlockHistory { get; init; }
    ...
    public bool IsCompressedBlocksEnabled { get; init; }
}
