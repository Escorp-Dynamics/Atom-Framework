...
/// </para>
/// <para>
/// Почему понадобился отдельный тип: общий <c>Atom.IO.ReverseBitReader</c> выдаёт биты внутри байта
/// от младшего к старшему и в <c>TrySkipPadding</c> обнуляет весь буфер после найденного маркера,
...
internal ref struct ZstdReverseBitReader
{
    ...
    /// </summary>
    /// <remarks>
    /// RFC 8878, §4.2.2: символ Хаффмана определяется по старшим <c>Max_Number_of_Bits</c> битам,
