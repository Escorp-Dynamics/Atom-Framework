...
/// возвращала длину заголовка из позиции предзагрузки <c lang="text">BitReader</c> (всегда 8 вместо реальных 3–5),
...
internal static class ZstdWeightsParser
{
    ...
    /// Прежний код читал поток прямым <c lang="text">BitReader</c> с начала блоба и вдобавок безусловно дописывал
