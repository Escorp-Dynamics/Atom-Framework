...
/// <summary>
/// Письмо Emailnator с поддержкой upstream-удаления.
/// </summary>
public sealed class EmailnatorMail : Mail
{
    private readonly EmailnatorAccount account;

    internal EmailnatorMail(
        EmailnatorAccount account,
        string upstreamId,
        Guid id,
        string from,
        string to,
